				...
				switch ( $block ) {
				    case 'product-activation':
                        ...
                        <div class="row brow">
	                       	...
	                       	<div class="col-md-10"><strong>Online Demo</strong><br> For our each product we have set up demo pages where you can see the plugin in working mode. You can see a working demo before making a purchase.<br><strong><a href="'.$this->demoURL.'" target="_blank" class="blue"> Click Here</a>.
	                         </div>
                        </div>';
