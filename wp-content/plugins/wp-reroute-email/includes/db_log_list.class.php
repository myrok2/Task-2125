...
class DBLogList extends WP_List_Table {
    ...
    function column_subject($item){
        $actions = array(
            'view'      => sprintf('<a href="?page=%s&tab=details&action=%s&logid=%s">' . __('View Message', 'wp_reroute_email') . '</a>',$_REQUEST['page'],'view',$item->id)
        );
    ...
    function get_columns(){
        $columns = array(
            'id' => 'ID',
            'subject'     => __('Subject', 'wp_reroute_email'),
            'recipients_to'    => __('Sent To', 'wp_reroute_email'),
            'sent_on'  => __('Sent On', 'wp_reroute_email')
        );
    ...
    function get_bulk_actions() {
        $actions = array(
            'delete_all_messages'    => __('Delete All Messages', 'wp_reroute_email')
        );
