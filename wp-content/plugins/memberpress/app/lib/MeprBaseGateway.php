    ...
    <?php /* <div class="mepr-account-row-actions"> */ ?>
      <?php if( $subscription->status != MeprSubscription::$pending_str ): ?>
        <?php if($subscription->status != MeprSubscription::$cancelled_str): ?>
          ...
          <a href="<?php echo site_url(); ?>/register/<?php echo $product->post_name; ?>/?action=checkout&txn=1vfc#mepr_jump" class="mepr-account-row-action mepr-account-update"><?php _e('Update', 'memberpress'); ?></a>

          <!-- <a href="<?php echo esc_url( get_permalink($product->ID) ); ?>" class="mepr-account-row-action mepr-account-update"><?php _e('Update', 'memberpress'); ?></a> -->
