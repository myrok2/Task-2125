        ...
        <label for="<?php echo MeprProduct::$tax_class_str; ?>">
          ...
          <?php
            MeprAppHelper::info_tooltip( 'mepr-register-price',
                                        __('Tax Rates', 'memberpress'),
                                        __('By default MemberPress will automatically apply standard tax rate. But in some cases you\'ll want to use a reduced rate for your membership.', 'memberpress') . '<br/><br/>' .
