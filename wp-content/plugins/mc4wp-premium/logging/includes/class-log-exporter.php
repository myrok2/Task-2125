...
class MC4WP_Log_Exporter {
	...
	public function build() {
		...
		// create csv header
		fputcsv( $fp, array( "email", "mailchimp_lists", "data", "type", "source", "datetime" ) );
	...
	public function output() {
		...
		if( ! $this->built ) {
			_doing_it_wrong( __METHOD__, 'You need to call the ' . __CLASS__ . '::build() method first.', MC4WP_PREMIUM_VERSION );
		}
