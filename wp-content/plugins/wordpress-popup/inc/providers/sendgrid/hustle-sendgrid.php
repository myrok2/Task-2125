	...
	public function configure_api_key( $submitted_data ) {
		...
		if ( $is_submit ) {
			...
			if ( ! $api_key_validated ) {
				$error_message = __( 'The API key is invalid for the selected Marketing Campaign. Please enter a valid API key or choose the correct Marketing Campaign version below.', 'wordpress-popup' );
				$has_errors = true;
			}
			...
			array(
				...
				'elements' => array(
					...
					'error' => array(
						...
						'value' => __( 'Please enter a valid SendGrid API key or choose the correct Marketing Campaign version below', 'wordpress-popup' ),
					),
				)
			),
			array(
				...
				'elements' => array(
					'new_campaigns' => array(
						...
						'options'     => array(
							'new_campaigns' => __( 'New', 'wordpress-popup' ),
							'legacy'        => __( 'Legacy', 'wordpress-popup' ),
						),
						'label'       => __( 'Marketing Campaigns', 'wordpress-popup' ),
						'description' => __( 'Choose the Marketing Campaigns version you are using.', 'wordpress-popup' ),
					),
				)
			),
			array(
