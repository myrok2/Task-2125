	...
	<div class="hui-actions-bar">
		...
		<form method="post" class="hustle-bulk-actions-container hui-bulk-actions">
			...
			<button
				...
				data-title="<?php esc_html_e( 'Delete Entries', 'wordpress-popup' ); ?>"
				data-description="<?php esc_html_e( 'Are you sure you wish to permanently delete these entries?', 'wordpress-popup' ); ?>"
				<?php disabled( true ); ?>
			>
