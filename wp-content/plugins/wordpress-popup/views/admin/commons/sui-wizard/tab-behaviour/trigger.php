			...
			<div class="sui-tabs-content sui-tabs-content-lg">
				...
				<div class="sui-tab-content{{ ( 'exit_intent' === triggers.trigger ) ? ' active' : '' }}"
					...
					<div class="sui-form-field">
						...
						<span class="sui-description sui-toggle-description" style="margin-top: 0;"><?php printf( esc_html__( 'This will delay the appearance of the %s after the user attempts to exit.', 'wordpress-popup' ), esc_html( $smallcaps_singular ) ); ?></span>
