	...
	<div class="sui-box-settings-col-2">
		...
		<?php if ( $is_optin ) { ?>
			...
			<div class="sui-form-field">
				...
				<span class="sui-description" style="margin-bottom: 10px;"><?php printf( esc_html__( "Choose the %s visibility once a visitor has opted-in Hustle's form.", 'wordpress-popup' ), esc_html( $smallcaps_singular ) ); ?></span>
		...
		<div class="sui-form-field" data-toggle-content="show-cta">
			...
			<label class="sui-settings-label"><?php esc_html_e( 'Visibility after CTA conversion', 'wordpress-popup' ); ?></label>

			<span class="sui-description" style="margin-bottom: 10px;"><?php printf( esc_html__( "Choose the %s visibility once a visitor has clicked on the CTA button.", 'wordpress-popup' ), esc_html( $smallcaps_singular ) ); ?></span>

			<select data-attribute="hide_after_cta">
				<option value="keep_show" {{ _.selected( ( 'keep_show' === hide_after_cta ), true) }}><?php esc_html_e( 'Keep showing this module', 'wordpress-popup' ); ?></option>
				<option value="no_show_all" {{ _.selected( ( 'no_show_all' === hide_after_cta ), true) }}><?php esc_html_e( 'No longer show this module across the site', 'wordpress-popup' ); ?></option>
				<option value="no_show_on_post" {{ _.selected( ( 'no_show_on_post' === hide_after_cta ), true) }}><?php esc_html_e( 'No longer show this module on this post/page', 'wordpress-popup' ); ?></option>
			</select>
