...
<div class="sui-box-settings-row" data-toggle-content="use-vanilla">
	...
	<div class="sui-box-settings-col-1">
		...
		<span class="sui-description"><?php printf( esc_html__( 'Choose a pre-made palette for your %1$s and further customize it.%2$sYou can also %3$screate custom palettes%4$s and reuse them on your modules.', 'wordpress-popup' ), esc_html( $smallcaps_singular ), '<br />&nbsp;<br />', '<a href="' . esc_url( $custom_pallete_url ) . '">', '</a>' ); ?></span>
	</div>
	...
	<div class="sui-box-settings-col-2">
		...
		<div class="sui-form-field">
			...
			<label for="hustle-color-palettes-list" id="hustle-color-palettes-list-label" class="sui-label"><?php esc_html_e( 'Select a color palette', 'wordpress-popup' ); ?></label>
			...
			<a href="<?php echo esc_url( $palettes_settings_url ); ?>" target="_blank" id="hustle-create-palette-link" class="hui-button">
				<?php esc_html_e( 'Create custom color palettes', 'wordpress-popup' ); ?>
			</a>
		</div>
