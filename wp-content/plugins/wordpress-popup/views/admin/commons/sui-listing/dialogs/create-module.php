				...
				<div role="document" class="sui-box">
					...
					<div class="sui-box-header sui-flatten sui-content-center sui-spacing-top--60">
						...
						<button id="hustle-new-module--type-close" class="sui-button-icon sui-button-float--right" data-modal-close="">
							...
							<span class="sui-screen-reader-text"><?php esc_html_e( 'Close create modal', 'wordpress-popup' ); ?></span>
						</button>

						<h4 id="hustle-new-module--type-title" class="sui-box-title sui-lg"><?php esc_html_e( 'Choose Content Type', 'wordpress-popup' ); ?></h4>

						<p id="hustle-new-module--type-description" class="sui-description"><?php esc_html_e( "Let's start by choosing an appropriate content type based on your goal.", 'wordpress-popup' ); ?></p>
					...
					<div class="sui-box-footer sui-flatten sui-content-right">
						...
						<button id="hustle-select-mode" class="sui-button"><?php esc_html_e( 'Next', 'wordpress-popup' ); ?></button>
				...
				<div class="sui-box-header sui-flatten sui-content-center sui-spacing-top--60">
					...
					<?php if ( ! $is_social_share ) { ?>
						...
						<button id="hustle-new-module--create-back" class="sui-button-icon sui-button-float--left">
							...
							<span class="sui-screen-reader-text"><?php esc_html_e( 'Go back to choose module content type', 'wordpress-popup' ); ?></span>
						</button>
					...
					<h4 id="hustle-new-module--create-title" class="sui-box-title sui-lg"><?php printf( esc_html__( 'Create %s', 'wordpress-popup' ), esc_html( $capitalize_singular ) ); ?></h4>

					<p id="hustle-new-module--create-description" class="sui-description"><?php printf( esc_html__( "Let's give your new %s module a name. What would you like to name it?", 'wordpress-popup' ), esc_html( $smallcaps_singular ) ); ?></p>
