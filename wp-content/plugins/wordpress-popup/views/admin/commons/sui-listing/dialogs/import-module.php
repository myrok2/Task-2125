	...
	>
		...
		<div role="document" class="sui-box">
			...
			<div class="sui-box-header sui-flatten sui-content-center sui-spacing-top--60">
				...
				<h3 id="hustle-dialog--import-title" class="sui-box-title sui-lg"><?php printf( esc_html__( 'Import %s', 'wordpress-popup' ), esc_html( $capitalize_singular ) ); ?></h3>

				<p id="hustle-dialog--import-description" class="sui-description"><?php esc_html_e( "Choose the configuration file and the settings you want to import. We'll import the settings which are available and apply to this module and keep the other settings to their default values.", 'wordpress-popup' ); ?></p>
			...
			<form id="hustle-import-module-form">
				...
				<div class="sui-box-body sui-box-body-slim">
					...
					<div class="sui-form-field">
						...
						<span class="sui-description" style="margin-top: 10px;"><?php esc_html_e( 'Choose the configuration file (.json) to import the settings from.', 'wordpress-popup' ); ?></span>
			...
			<# if ( isNew ) { #>
				...
				<div class="sui-tabs sui-side-tabs">
					...
					<div role="tablist" class="sui-tabs-menu">
						...
						>
							<?php esc_html_e( 'Default', 'wordpress-popup' ); ?>
						</button>
						...
						>
							<?php esc_html_e( 'Email Opt-in', 'wordpress-popup' ); ?>
						</button>
						...
						<button
							...
							tabindex="-1"
						>
							<?php esc_html_e( 'Informational', 'wordpress-popup' ); ?>
						</button>
					...
					<p class="sui-description"><?php printf( __( 'Choose the module type of the %s you want to create. The default is to take the module type from the configuration file and import all the settings from it.', 'wordpress-popup' ), $module_type_display_name ); ?></p>
