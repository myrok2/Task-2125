			...
			<div class="sui-box" role="document">
				...
				<div class="sui-box-header sui-flatten sui-content-center sui-spacing-top--60">
					...
					<h3 class="sui-box-title sui-lg">
						...
						<?php printf( esc_html__( 'Hey, %s', 'wordpress-popup' ), esc_html( $username ) ); ?>
					</h3>

					<p class="sui-description"><?php esc_html_e( "Welcome to Hustle, the only plugin you'll ever need to turn your visitors into loyal subscribers, leads and customers.", 'wordpress-popup' ); ?></p>
		...
		<div id="hustle-dialog--migrate-slide-2" class="sui-modal-slide">
			...
			<div class="sui-box" role="document">
				...
				<div class="sui-box-header sui-flatten sui-content-center sui-spacing-top--60">
					...
					>
						<?php esc_html_e( 'Nice work on updating the Hustle! All your modules are already in place. However, You need to migrate the data of your existing modules such as tracking data and email list manually.', 'wordpress-popup' ); ?>
					</p>
			...
			<button class="sui-modal-skip hustle-dialog-migrate-skip" data-modal-close><?php esc_html_e( "Skip this, I'll migrate data later", 'wordpress-popup' ); ?></button>
			...
			<div class="sui-box" role="document">
				...
				<div class="sui-box-header sui-flatten sui-content-center sui-spacing-top--60">
					...
					<button class="sui-button-icon sui-button-float--right" data-modal-close>
						...
						<span class="sui-screen-reader-text"><?php esc_html_e( 'Close this modal', 'wordpress-popup' ); ?></span>
					</button>
					...
					<h3 class="sui-box-title sui-lg"><?php esc_html_e( 'Create Module', 'wordpress-popup' ); ?></h3>
