<div class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-2">
		...
		<div class="sui-form-field">
			...
			<label for="hustle-sender-email" id="hustle-sender-email-label" class="sui-label"><?php esc_html_e( 'Sender email address', 'wordpress-popup' ); ?></label>
		...
		<div class="sui-form-field">
			...
			<label for="hustle-sender-name" id="hustle-sender-name-label" class="sui-label"><?php esc_html_e( 'Sender name', 'wordpress-popup' ); ?></label>

			<input
				type="text"
				name="sender_email_name"
				value="<?php echo isset( $settings['sender_email_name'] ) ? esc_attr( $settings['sender_email_name'] ):''; ?>"
				placeholder="<?php esc_html_e( 'Website Title', 'wordpress-popup' ); ?>"
