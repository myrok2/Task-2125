...
<div id="email-copy-row" class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-1">
		...
		<span class="sui-description"><?php esc_html_e( 'Customize the copy of the email that will be received by the visitors with the unsubscribe link.', 'wordpress-popup' ); ?></span>
	</div>
