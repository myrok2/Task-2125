...
<div class="sui-wrap<?php echo ! empty( $accessibility['accessibility_color'] ) ? ' sui-color-accessible' : ''; ?>">
	...
	if ( $is_module_selected ) :
		...
		$add_local_list = sprintf( esc_html__( 'Hustle\'s Local List is inactive for this %1$s. %2$sActivate Local List%3$s integration for this module to store the submissions in your database and see those submissions here.', 'wordpress-popup' ),
		...
		<?php elseif ( $no_local_list ) : ?>
			...
			<div class="sui-box sui-message">
				...
				<div class="sui-message-content">
					...
					<h2><?php esc_html_e( 'Local List is Inactive!', 'wordpress-popup' ); ?></h2>
