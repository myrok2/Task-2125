...
if ( ! class_exists( 'Opt_In' ) ) :
	...
	class Opt_In extends Opt_In_Static{
		...
		public function in_plugin_update_message( $project_id, $plugin_data, $project_name = '' ) {
			...
			$heads_up = __( 'Heads up!', 'wordpress-popup' );
			$title = sprintf( __( 'We’ve fixed visibility conditions in Hustle %1$s which may affect the visibility behavior of your pop-ups and other modules.', 'wordpress-popup' ), $plugin_data->new_version );
